...
```
随机写入进程的历史最佳状态: 114.1 seconds左右
随机读取进程的历史最佳状态: 105.9 seconds左右 (包括0.2 seconds index构建)
顺序读取进程的历史最佳状态: 192.1 seconds左右 (包括0.2 seconds index构建)
```
...
* 其中，历史最佳成绩离理论历史最佳成绩累加差了`0.69 seconds`；
